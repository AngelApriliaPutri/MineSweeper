...
namespace mine
{
    public partial class Form1 : Form
    {
        ...
        {
            // Mengatur ulang posisi tombol-tombol Easy, Medium, dan Hard
            btnEasy.Location = new Point(300, 100); // Atur posisi tombol Easy
            btnMedium.Location = new Point(300, 210); // Atur posisi tombol Medium
            btnHard.Location = new Point(300, 320); // Atur posisi tombol Hard
